...
export const CRITTERS: Critter[] = [
  ...
  { id: "bubblefin", name: "Bubblefin", title: "Puddle Pal", icon: "🐟", sprite: "./critters/bubblefin-sprite.png", color: "#54bde8", cost: 55, damage: 12, speed: 3, range: 3, rarity: "Common", tier: 1, starterEligible: true, ability: "splash", skill: "Bubble Burst: splashes its target and nearby enemies in a small area." },
  ...
  { id: "sparkit", name: "Sparkit", title: "Storm Kitten", icon: "🐱", sprite: "./critters/sparkit-sprite.png", color: "#f5c84b", cost: 75, damage: 23, speed: 3, range: 2, rarity: "Common", tier: 1, starterEligible: true, wishOnly: true, ability: "lightning", skill: "Chain Spark: arcs to 2 additional enemies, losing damage with every jump." },
  { id: "bloomwing", name: "Bloomwing", title: "Garden Sprite", icon: "🦋", sprite: "./critters/bloomwing-sprite.png", color: "#e982b5", cost: 80, damage: 28, speed: 3, range: 3, rarity: "Common", tier: 1, starterEligible: true, wishOnly: true, ability: "piercing", skill: "Petal Needle: ignores shields and strikes health directly." },
  { id: "moonowl", name: "Moonowl", title: "Star Watcher", icon: "🦉", sprite: "./critters/moonowl-sprite.png", color: "#9b88e8", cost: 95, damage: 48, speed: 5, range: 4, rarity: "Common", tier: 1, starterEligible: true, wishOnly: true, ability: "push", skill: "Moonpulse: pushes its target backwards along the path." },
  ...
  { id: "ripplefin", name: "Ripplefin", title: "River Dancer", icon: "🐠", sprite: "./critters/ripplefin-sprite.png", color: "#3db6df", cost: 82, damage: 18, speed: 3, range: 3, rarity: "Rare", tier: 2, ability: "splash", skill: "Ripple Burst: creates a wider splash with stronger secondary damage.", evolutionPath: "core", upgradeOf: "bubblefin" },
  ...
  { id: "voltlynx", name: "Voltlynx", title: "Thunder Prowler", icon: "🐈", sprite: "./critters/voltlynx-sprite.png", color: "#eab72f", cost: 100, damage: 33, speed: 3, range: 3, rarity: "Rare", tier: 2, ability: "lightning", skill: "Forked Spark: chains to 3 additional enemies and retains more damage.", evolutionPath: "core", upgradeOf: "sparkit" },
  { id: "briarwing", name: "Briarwing", title: "Thorn Dancer", icon: "🦋", sprite: "./critters/briarwing-sprite.png", color: "#d95d9d", cost: 105, damage: 40, speed: 3, range: 4, rarity: "Rare", tier: 2, ability: "piercing", skill: "Briar Needle: ignores shields and deals bonus damage to shielded foes.", evolutionPath: "core", upgradeOf: "bloomwing" },
  { id: "duskowl", name: "Duskowl", title: "Twilight Seer", icon: "🦉", sprite: "./critters/duskowl-sprite.png", color: "#7967cf", cost: 120, damage: 66, speed: 4, range: 4, rarity: "Rare", tier: 2, ability: "push", skill: "Duskpulse: pushes enemies farther backwards along the path.", evolutionPath: "core", upgradeOf: "moonowl" },
  ...
  { id: "tidecaller", name: "Tidecaller", title: "Ocean Oracle", icon: "🐬", sprite: "./critters/tidecaller-sprite.png", color: "#279fd1", cost: 122, damage: 28, speed: 2, range: 4, rarity: "Legendary", tier: 3, ability: "splash", skill: "Tidal Burst: creates the largest splash with powerful secondary damage.", evolutionPath: "core", upgradeOf: "ripplefin" },
  ...
  { id: "stormsabre", name: "Stormsabre", title: "Skyfang Regent", icon: "🐯", sprite: "./critters/stormsabre-sprite.png", color: "#d99b1f", cost: 138, damage: 48, speed: 2, range: 3, rarity: "Legendary", tier: 3, ability: "lightning", skill: "Tempest Chain: arcs through 5 enemies while retaining most of its power.", evolutionPath: "core", upgradeOf: "voltlynx" },
  { id: "crownwing", name: "Crownwing", title: "Royal Petalblade", icon: "🦚", sprite: "./critters/crownwing-sprite.png", color: "#bd4b91", cost: 142, damage: 58, speed: 3, range: 4, rarity: "Legendary", tier: 3, ability: "piercing", skill: "Crown Needle: ignores shields and punishes shielded enemies for 30% bonus damage.", evolutionPath: "core", upgradeOf: "briarwing" },
  { id: "celestowl", name: "Celestowl", title: "Astral Witness", icon: "🦅", sprite: "./critters/celestowl-sprite.png", color: "#6552bb", cost: 155, damage: 86, speed: 4, range: 5, rarity: "Legendary", tier: 3, ability: "push", skill: "Starfall Pulse: powerfully pushes enemies backwards; bosses resist half the distance.", evolutionPath: "core", upgradeOf: "duskowl" },
];
