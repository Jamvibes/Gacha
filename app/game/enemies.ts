...
export const ENEMY_DEFINITIONS: EnemyDefinition[] = [
  { id: "gloomling", name: "Gloomling", title: "Restless Shadow", icon: "👾", sprite: "./enemies/gloomling-sprite.png", role: "Basic foe", chapter: "All chapters", defence: "No shield", abilityText: "Skitter: steady movement with no special protection.", color: "#816d9d", ability: "basic", budget: 1, minDifficulty: 1, hpMultiplier: 1, speedMultiplier: 1, shieldRatio: 0, petalReward: 1 },
  { id: "gloomlet", name: "Gloomlet", title: "Freshly Split Shadow", icon: "▪️", sprite: "./enemies/gloomlet-sprite.png", role: "Split offspring", chapter: "All chapters", defence: "Very fragile", abilityText: "A small fragment created by a defeated Shadepod.", color: "#9a89b3", ability: "fast", budget: 0, minDifficulty: 1, hpMultiplier: 0.32, speedMultiplier: 1.25, shieldRatio: 0, petalReward: 0, pool: false },
  { id: "mossmaw", name: "Mossmaw", title: "Stubborn Stomper", icon: "🪨", sprite: "./enemies/mossmaw-sprite.png", role: "Extra-health foe", chapter: "All chapters", defence: "Very high health", abilityText: "Thick Hide: carries more than twice the health of a Gloomling but moves slowly.", color: "#6f8059", ability: "tank", budget: 2.5, minDifficulty: 2, hpMultiplier: 2.25, speedMultiplier: 0.72, shieldRatio: 0, petalReward: 2 },
  { id: "bramble-brute", name: "Bramble Brute", title: "Armoured Thicket", icon: "👹", sprite: "./enemies/bramble-brute-sprite.png", role: "Shielded foe", chapter: "All chapters", defence: "Barkshield: 35% shield", abilityText: "Barkshield adds a protective barrier that piercing attacks can ignore.", color: "#71824e", ability: "shield", budget: 2.5, minDifficulty: 5, hpMultiplier: 1.35, speedMultiplier: 0.88, shieldRatio: 0.35, petalReward: 2 },
  { id: "whispling", name: "Whispling", title: "Hurrying Wisp", icon: "💨", sprite: "./enemies/whispling-sprite.png", role: "Fast fragile foe", chapter: "All chapters", defence: "Low health", abilityText: "Tailwind: moves 70% faster than a Gloomling but has much less health.", color: "#79a7b6", ability: "fast", budget: 1, minDifficulty: 4, hpMultiplier: 0.55, speedMultiplier: 1.7, shieldRatio: 0, petalReward: 1 },
  { id: "shadepod", name: "Shadepod", title: "Hatching Gloom", icon: "🫐", sprite: "./enemies/shadepod-sprite.png", role: "Splitting foe", chapter: "All chapters", defence: "Moderate health", abilityText: "Gloom Hatch: splits into two fast Gloomlets when defeated. Gloomlets grant no extra rewards.", color: "#73567f", ability: "split", budget: 3, minDifficulty: 6, hpMultiplier: 1.15, speedMultiplier: 0.86, shieldRatio: 0, petalReward: 3, splitInto: 2 },
  { id: "mender-moth", name: "Mender Moth", title: "Gloom Caretaker", icon: "🦋", sprite: "./enemies/mender-moth-sprite.png", role: "Healing support", chapter: "All chapters", defence: "Low health", abilityText: "Mending Dust: periodically restores nearby non-healer enemies, but cannot heal itself.", color: "#b171a5", ability: "heal", budget: 4, minDifficulty: 7, hpMultiplier: 0.8, speedMultiplier: 0.78, shieldRatio: 0, petalReward: 4 },
  { id: "thornmaw", name: "The Thornmaw", title: "Meadow Devourer", icon: "🐲", sprite: "./enemies/thornmaw-sprite.png", role: "Boss", chapter: "Chapter 1 · Sundew Meadow", defence: "Royal Ward: 20% shield", abilityText: "A colossal creature with exceptional health, a protective ward, and resistance to push-back.", color: "#9a5b69", ability: "boss", budget: 0, minDifficulty: 10, hpMultiplier: 1, speedMultiplier: 0.72, shieldRatio: 0.2, petalReward: 25, pool: false, boss: true },
  { id: "mire-monarch", name: "The Mire Monarch", title: "Sovereign of the Mist", icon: "🐙", sprite: "./enemies/mire-monarch-sprite.png", role: "Boss", chapter: "Chapter 2 · Moonpetal Marsh", defence: "Royal Ward: 20% shield", abilityText: "Rules the marsh with colossal health, a protective ward, and resistance to push-back.", color: "#567d83", ability: "boss", budget: 0, minDifficulty: 20, hpMultiplier: 1, speedMultiplier: 0.72, shieldRatio: 0.2, petalReward: 25, pool: false, boss: true },
  { id: "hollow-crown", name: "The Hollow Crown", title: "Starless Usurper", icon: "👑", sprite: "./enemies/hollow-crown-sprite.png", role: "Final boss", chapter: "Chapter 3 · Starlight Canopy", defence: "Royal Ward: 20% shield", abilityText: "The final guardian of the Gloom, fortified by colossal health and resistance to push-back.", color: "#6e588d", ability: "boss", budget: 0, minDifficulty: 30, hpMultiplier: 1, speedMultiplier: 0.72, shieldRatio: 0.2, petalReward: 25, pool: false, boss: true },
];
